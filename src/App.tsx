    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 p-8 font-sans">
      ...
      <div className="max-w-xl mx-auto">
         <div className="flex justify-between items-center mb-10">
            ...
            <button onClick={() => setIsAdmin(false)} className="bg-white px-6 py-3 rounded-2xl shadow-sm border font-bold text-sm flex items-center gap-2"><ArrowLeft size={16} /> Player View</button>
         </div>
         ...
         <div className="space-y-6">
            ...
            <div className="flex justify-between items-center px-4">
               ...
               <button onClick={() => setEditingStage({ id: 'NEW', order: game.stages.length+1, title: '新任務', storyContent: '', unlockType: 'PASSWORD', unlockAnswer: '1234', hints: [''], successMessage: '任務達成！' })} className="bg-indigo-600 text-white px-4 py-2 rounded-xl font-bold text-xs flex items-center gap-2 shadow-xl shadow-indigo-100"><Plus size={16}/> New Stage</button>
            </div>
